  ...
  experience: [
    {
      ...
      from: "07/2025",
      to: "Presente",
      tasks: "Collaborazione nello sviluppo e manutenzione di un software gestionale per il settore catering, lavorando con C#, .NET, MudBlazor e SQL Server Management Studio per la gestione dei dati. Attività di analisi requisiti, interfacce utente e debug, in affiancamento al team di sviluppo.",
    },
    {
      ...
      from: "01/2025",
      to: "06/2025",
      tasks: "Tecnico della progettazione, sviluppo, testing e manutenzione del software.",
    },
  ],
  education: [
